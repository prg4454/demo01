...
export class FriendsComponent implements OnInit {
    ...
    private async loadData() {
        ...
        this.friends = (await this.storageService.getAll<FriendRecord>('friends')).map((friend) => this.normalizeFriend(friend));
        this.friends.sort((a, b) => b.id - a.id);
    }

    private normalizeFriend(friend: FriendRecord): FriendRecord {
        return {
            ...friend,
        ...
        return [
            {
                ...
                yearsKnown: 14,
                activities: [
                    { id: 1, title: 'Saturday Trail Run', when: '2026-08-02 7:30 AM', location: 'Bear Creek', notes: 'Bring water and gels.' }
                ]
            },
            { id: 2, name: 'Ethan Brooks', city: 'Austin', hobby: 'Guitar', status: 'Close Friend', birthday: '1991-09-03', yearsKnown: 11, activities: [] },
            { id: 3, name: 'Mia Patel', city: 'Chicago', hobby: 'Pottery', status: 'Friend', birthday: '1994-12-26', yearsKnown: 7, activities: [] },
            {
                id: 4,
                name: 'Liam Nguyen',
                city: 'Seattle',
                ...
                yearsKnown: 15,
                activities: [
                    { id: 1, title: 'Board Game Night', when: '2026-08-09 6:30 PM', location: 'Liam\'s Place', notes: 'Bring strategy games.' },
                    { id: 2, title: 'Coffee Catch-up', when: '2026-08-13 8:00 AM', location: 'Downtown Cafe', notes: '' }
                ]
            },
            { id: 5, name: 'Noah Green', city: 'Phoenix', hobby: 'Photography', status: 'Friend', birthday: '1993-08-22', yearsKnown: 6, activities: [] },
            { id: 6, name: 'Sophia Diaz', city: 'San Diego', hobby: 'Surfing', status: 'Close Friend', birthday: '1995-01-14', yearsKnown: 9, activities: [] },
            { id: 7, name: 'Lucas Moore', city: 'Boston', hobby: 'Cycling', status: 'Friend', birthday: '1992-06-30', yearsKnown: 5, activities: [] },
            { id: 8, name: 'Emma Ross', city: 'Nashville', hobby: 'Baking', status: 'New Friend', birthday: '1996-10-07', yearsKnown: 2, activities: [] },
            { id: 9, name: 'Oliver King', city: 'Portland', hobby: 'Cooking', status: 'Close Friend', birthday: '1989-03-09', yearsKnown: 12, activities: [] },
            { id: 10, name: 'Grace Turner', city: 'Miami', hobby: 'Yoga', status: 'Friend', birthday: '1994-11-19', yearsKnown: 4, activities: [] },
            { id: 11, name: 'Henry Bell', city: 'Dallas', hobby: 'Woodworking', status: 'Friend', birthday: '1990-07-28', yearsKnown: 8, activities: [] },
            { id: 12, name: 'Chloe Ward', city: 'Minneapolis', hobby: 'Painting', status: 'New Friend', birthday: '1997-05-16', yearsKnown: 1, activities: [] }
        ];
    }
    ...
    openActivitiesModal(friend: FriendRecord): void {
        ...
        modalRef.componentInstance.friend = structuredClone(friend);
        modalRef.componentInstance.allowDelete = true;
        modalRef.componentInstance.openActivitiesOnInit = true;
